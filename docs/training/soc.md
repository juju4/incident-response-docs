...
Few of many, mostly free content or partially.

## CTF, Ranges... - Hands-on

* [SOC Core Skills with John Strand](https://www.antisyphontraining.com/course/soc-core-skills-with-john-strand/)
* [Constructing Defense, Build the Ultimate Cybersecurity Purple Teaming Home Lab](https://course.constructingdefense.com/constructing-defense)
* [Blue Team Labs Online](https://blueteamlabs.online/)
* [Our Free Courses - Security Blue Team](https://support.securityblue.team/hc/en-gb/articles/11316274536476-Our-Free-Courses)
...
* [Flare-On RE challenge, 2014-2025](https://www.flare-on.com/)
* https://overthewire.org/wargames/
* [Root Me](https://www.root-me.org/?lang=en)
* [Command challenge](https://cmdchallenge.com/)
* [CTFTime CTFs list](https://ctftime.org/ctfs)
* [Splunk Boss of the SOC](https://bots.splunk.com/login)
* [KQL Made Less Scary: A Practical Starting Point Hidden in Plain Sight](https://securingm365.com/defenderxdr/sentinel/kqlactivitytemplates/)
* [MalwareTech Labs is a library of reverse engineering challenges that replicate techniques used in real-world malware. ](https://www.malwaretech.com/labs/)
* [Introducing The Cloud Hunting Games CTF: Test Your Cloud Incident Response Skills, May 2025](https://www.wiz.io/blog/the-cloud-hunting-games-ctf-challenge), <https://www.cloudhuntinggames.com/>
...
* [Network Forensics Puzzle Contest, 2013-2015](https://forensicscontest.com/)
* [DFRWS Forensic Challenges](https://dfrws.org/forensic-challenges/)
* [Forensic Challenge - The Honeynet project](https://www.honeynet.org/challenges/)
* [Puzzle #1: Ann’s Bad AIM, Sep 2009](https://forensicscontest.com/2009/09/25/puzzle-1-anns-bad-aim)

Commercial
* https://www.sans.org/cyber-ranges/
* https://www.blackhillsinfosec.com/services/cyber-range/
* https://cyberstruggle.org/s-46-platform/
* https://fieldeffect.com/products/cyber-range-security-training/
* https://www.diateam.net/cyber-security-training-and-exercises/, https://www.bluecyforce.com/
* [Master Digital Forensics with Hands-on Labs - DFIRLabs](https://dfirlabs.thedfirreport.com/auth/login)
...
* <https://www.reconinfosec.com/training/>
* <https://securityblue.team/training/>
* Pluralsight: [Security Event Triage](https://www.pluralsight.com/paths/security-event-triage-skill), [Incident Response](https://www.pluralsight.com/paths/incident-response), [Communication Skills for Technologists](https://www.pluralsight.com/paths/communication-skills-for-technologists), [Enhancing Your Critical Thinking Skills](https://www.pluralsight.com/courses/enhancing-critical-thinking-skills)
...
Regular webinars
* [Wednesday Offensive](https://redsiege.com/wednesday-offensive/)
* [Thursday Defensive](https://www.reconinfosec.com/thursday-defensive/)
* [Defender Fridays](https://limacharlie.io/defender-fridays)
* [Atomics on a Friday](https://github.com/Atomics-on-A-Friday/Episode-Notes), <https://www.youtube.com/@atomicsonafriday>

## Podcasts

* [ISC SANS Daily](https://isc.sans.edu/podcast.html)
* [Down the Security Rabbithole Podcast (DtSR)](https://dtsr.buzzsprout.com/)
* [The Azure Security Podcast](https://azuresecuritypodcast.azurewebsites.net/)
* [Nolimitsecu - FR](https://www.nolimitsecu.fr/)

## Communities

Online Forums/chats
* [Discord BTV](https://discord.gg/blueteamvillage), [Blue Team Village - Project Obsidian](https://blueteamvillage.org/programs/project-obsidian/), [DEFCON 30 | Project Obsidian](https://github.com/blueteamvillage/Project-Obsidian-DC30), [Project Obsidian @ DEFCON 31](https://github.com/blueteamvillage/Project-Obsidian-DC31), [Defcon 33 presentations](https://github.com/blueteamvillage/dc33-presentations/tree/main/101-Content), [Blue Team Village - Youtube playlists](https://www.youtube.com/c/BlueTeamVillage/playlists)
* [Discord BHIS](https://discord.com/invite/bhis)
...
Mixed
* [DigitalCorpora.org is a website of digital corpora for use in computer forensics education research. All of the disk images, memory dumps, and network packet captures available on this website are freely available and may be used without prior authorization or IRB approval.](https://digitalcorpora.org/)
* [SecRepo.com - Samples of Security Related Data](https://www.secrepo.com/)
* [FORENSIC CHALLENGES mindmap](https://www.amanhardikar.com/mindmaps/ForensicChallenges.html)
* BlueTeamVillage Project Obsidian: [DC29 Forensics and Memory](https://github.com/blueteamvillage/Project-Obsidian-DC29), [DC30 Forensics and Logs](https://github.com/blueteamvillage/Project-Obsidian-DC30/), [DC31 Forensics and Logs](https://github.com/blueteamvillage/Project-Obsidian-DC31), [DC33 Forensics and Logs](https://s3.us-west-2.amazonaws.com/media.blueteamvillage.org/index.html#DC33/CTF-OBSIDIAN/)
* [DFIR Training test images](https://www.dfir.training/downloads/test-images)
* [The Evidence Locker - A DFIR Image Compendium, Nov 2025](https://www.stark4n6.com/2025/11/the-evidence-locker-dfir-image.html), <https://theevidencelocker.github.io/>
* [End-to-end ransomware attack simulation logs for DFIR/SOC analysts](https://github.com/moex01/shadowtracker-elastic-logs/releases)

Memory
* [Memory Samples - Archived volatility2 repo](https://github.com/volatilityfoundation/volatility/wiki/Memory-Samples)
* [MemLabs is an educational, introductory set of CTF-styled challenges which is aimed to encourage students, security researchers and also CTF players to get started with the field of Memory Forensics.](https://github.com/stuxnet999/MemLabs)
* [Project 5: Analyzing a RAM Image with Volatility (15 Points) - samclass](https://samsclass.info/121/proj/p5-Vol.htm)

Disks
* [Digital Forensics Tool Testing Images, 2003-2010](https://dftt.sourceforge.net/)
* [The disktype File System Sampler, 2003-2006](https://disktype.sourceforge.net/fss/)
* [Forensic Practical Exercise - ForensicKB, 2008-2010](https://www.forensickb.com/search?q=practical)

Pcap
* [SampleCaptures - Wireshark wiki](https://wiki.wireshark.org/SampleCaptures)
* [Publicly available PCAP files - Netresec](https://www.netresec.com/?page=PcapFiles)
* [Packet Captures - chrissanders](https://github.com/chrissanders/packets)
* [This repository will hold PCAP IOC data related with known malware samples (owner: Bryant Smith) ](https://github.com/SpiderLabs/IOCs-IDPS)
* [Malware Capture Facility Project by the Stratosphere Laboratory](https://mcfp.felk.cvut.cz/publicDatasets/datasets.html)
* [A site for sharing packet capture (pcap) files and malware samples.](https://malware-traffic-analysis.net/)
* [Pcap - ismellpackets, 2009-2012](https://ismellpackets.com/category/pcap/)

Logs
* [Log Samples - OSSEC](https://www.ossec.net/docs/log_samples/)
* Boss of the SOC (BOTS) Dataset: [bots v1](https://github.com/splunk/botsv1), [bots v2](https://github.com/splunk/botsv2), [bots v3](https://github.com/splunk/botsv3)
* [End-to-end ransomware attack simulation logs for DFIR/SOC analysts](https://github.com/moex01/shadowtracker-elastic-logs) (see releases)
* [Generate datasets of cloud audit logs for common attacks](https://github.com/DataDog/grimoire)

Other data
* [Enron Corpus](https://en.wikipedia.org/wiki/Enron_Corpus): "database of over 600,000 emails written by 158 employees[1] of the Enron Corporation in the years leading up to the company's collapse in December 2001"
* [The Pile (dataset)](https://en.wikipedia.org/wiki/The_Pile_(dataset)): "886 GB diverse, open-source dataset of English text created as a training dataset for large language models (LLMs)"
* [The COMPLETE translation of leaked files related to Conti Ransomware group](https://github.com/NorthwaveSecurity/complete_translation_leaked_chats_conti_ransomware)
* [Part of UC3BPR20 2024 - Acquisition and Analysis of Forensic Artefacts in a Smart Home Environment: A Study in IoT Forensics](https://github.com/oeeve/UC3BPR20)

## Lab

* [Game Of Active Directory](https://github.com/Orange-Cyberdefense/GOAD) (Local, Aws, Azure...)
* [DetectionLabELK is a fork from DetectionLab with ELK stack instead of Splunk.](https://github.com/cyberdefenders/DetectionLabELK) (Local)
...
* [Degree Apprenticeship BSc (Hons) Data Science Data Scientist, UK](https://www.aru.ac.uk/study/degree-apprenticeships/employer/our-courses/data-scientist-employer-information)
